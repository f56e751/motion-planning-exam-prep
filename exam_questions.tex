...
{\large 강의안 L00--L11 (L12 NMPC 출제 제외) / cheat sheet 지참 가능 · 계산기 사용 불가}}
\author{}
\date{2026 Spring}
...
각 강의안(L00--L11)별 출제 가능성 높은 문제 (메인 + 보조 ± 보조2), 총 \textbf{26문제}. \textbf{L12 NMPC/PMP는 출제 제외} (강의 공지 반영). 풀이는 문제 바로 아래.
...
총 \textbf{26문제} (L12 NMPC/PMP는 출제 제외 --- 강의 공지 반영).
...
\begin{itemize}
  ...
  \item \textbf{유도 문제 1--2개}: L06 min-jerk 차수 / L05 chained form 중.
...
총 \textbf{26문제}. L12 NMPC/PMP는 출제 제외. 풀이는 cheat sheet 없이도 따라갈 수 있도록 단계별. 손계산 가능한 수치만 사용.
